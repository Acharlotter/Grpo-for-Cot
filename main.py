...
def parse_args():
    ...
    parser.add_argument("--input_path", type=str, default="C:\\AAa_char\\tianchi-competition3\\TC3\\code\\data\\input.csv", help="输入数据路径")
    ...
    parser.add_argument("--model_name_or_path", type=str, default="C:\\AAa_char\\tianchi-competition3\\TC3\\output\\sft\\final", help="模型名称或路径")
